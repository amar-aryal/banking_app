  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Account Details', style: TextStyle(color: Colors.white, fontSize: 24.0),),
        centerTitle: true,
        actions: <Widget>[
          Padding(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  Flexible(
                    child: Padding(
                      ...
                      child: RichText(
                        text: TextSpan(
                          text: 'Dear ${amar.accountholder}, your balance is:',
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 24.0,
                          ),
                          children: <TextSpan>[
                            TextSpan(text: '    Rs.${amar.balance}', style: TextStyle(color: Colors.purpleAccent, fontSize: 38.0, fontWeight: FontWeight.bold))
                          ]
                        )
                      ),
                    ),
            ...
            Text(
              'Activities',
              style: TextStyle(color: Colors.white, fontSize: 34.0, fontWeight: FontWeight.bold, letterSpacing: 1.5)
            ),
            Row(
              children: <Widget>[
                GestureDetector(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text('Withdraw money', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, letterSpacing: 1.5)),
                        )
                      ],
                    ),
                  ),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Padding(
                          padding: EdgeInsets.all(25.0),
                          child: Text('Deposit money', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, letterSpacing: 1.5)),
                        )
                      ],
                    ),
                  ),
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            title: Text('Withdrawls', style: TextStyle(color: Colors.white, fontSize: 18.0),),
            onTap: (){},
          ),
          ListTile(
            title: Text('Deposits', style: TextStyle(color: Colors.white, fontSize: 18.0),),
            onTap: (){},
          ),
          ListTile(
            title: Text('Back', style: TextStyle(color: Colors.white, fontSize: 18.0),),
